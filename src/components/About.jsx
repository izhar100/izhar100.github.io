        ...
        <>
            <Grid pt={"100px"} m="auto" templateColumns={{ sm:"1fr", md: "1fr 1fr" }} w={{md:"80%",lg:"80%",xl:"80%",sm:"95%"}} mt={5} gap={5}>
                <Box order={{sm:2,md:1,base:2,lg:1}} textAlign={{sm:"center",base:"center",md:"left",lg:"left"}}>
                    ...
                    <a href="https://drive.google.com/file/d/1qy06lYUfPUNwB1aZ8nCxTd224rMdg3ps/view?usp=sharing" target='_black'><Button mt={"5px"} bg={"#805AD5"} color={"white"} _hover={{cursor:"pointer"}}  as={'b'}><Flex alignItems={'center'} gap="1">RESUME <FaArrowAltCircleDown/></Flex></Button></a>
                </Box>
